...
namespace Umetric\Utility\Redux_Framework;
...
class Component implements Component_Interface
{
	...
	protected $opt_name = "umetric_options";
	/**
	...
	public function action_add_redux()
	{
		...
		$args = array(
			...
			'menu_title'           => esc_html__('Umetric Options', 'umetric'),
			'page_title'           => esc_html__('Umetric Options', 'umetric'),

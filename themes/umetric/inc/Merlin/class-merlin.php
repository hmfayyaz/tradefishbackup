...
class Merlin
{
	...
	function __construct($config = array(), $strings = array())
	{
		...
		add_action('init', array($this, 'umetric_download_file'));
	}
		...
		<body class="merlin__body merlin__body--<?php echo esc_attr($current_step); ?>">
			...
			<div class="wizard-progress current-step-<?php echo esc_attr($this->step); ?>">
				<div class="step <?php echo esc_attr($class_welcome); ?>">
					<?php echo esc_html__("Welcome", "umetric"); ?>
					<div class="node">
		...
		<div class="merlin__content--transition">
			...
			<div class="content-right">
				<div class="content-right-inner">
					...
					<table>
						<tr class="heading">
							<th><?php esc_html_e('PHP Configuration', 'umetric') ?></th>
							<th><?php esc_html_e('Recommended (Min)', 'umetric') ?></th>
							<th><?php esc_html_e('Existing', 'umetric') ?></th>
						</tr>
						<tr>
		...
		<div class="merlin__content--transition">
			...
			<div class="content-right">
				<div class="content-right-inner">
					...
					<p>
						<strong><?php esc_html_e("About child theme", "umetric"); ?></strong><br>
						<?php
						esc_html_e("A child theme allows you to change small aspects of your site's appearance yet still preserve your theme's look and functionality. To understand how child themes work it is first important to understand the relationship between parent and child themes.", "umetric");
						?>
	...
	protected function content()
	{
		...
		?>
			<div class="plugin-installation-error">
				...
				<h1>
					<?php esc_html_e("Something went worng !", "umetric"); ?>
				</h1>
				<strong>
					<?php esc_html_e(" Below listed plugin has been not installed. Install it mannually or submit the ticket for Help.", "umetric"); ?>
				</strong>
				<ul class="merlin__drawer--install-plugins">
					<?php foreach ($plugins['all'] as $slug => $plugin) { ?>
						<li>
							...
							<span class="download-link">
								<a href="<?php echo esc_url($url) ?>" target="_blank"><?php esc_html_e("Download", "umetric"); ?></a>
							</span>
						</li>
					<?php } ?>
				</ul>
				<div class="plugin-installation-links">
					<a href='<?php echo admin_url('themes.php?page=umetric-setup&step=plugins'); ?>' class='merlin__button merlin__button--knockout merlin__button--no-chevron merlin__button--external'><?php esc_html_e("Try Again", "umetric"); ?></a>
					<a href="https://iqonic.desky.support/" class="merlin__button merlin__button--knockout merlin__button--no-chevron merlin__button--external" target="_blank"><?php esc_html_e('Get Support', 'umetric'); ?></a>
				</div>
			</div>
		<?php
			return;
	...
	public function generate_child_functions_php($slug)
	{
		...
		$output = "
			 ...
			 * This child theme was generated by Umetric.
			 *
...
<?php
	...
	public function umetric_download_file()
	{
		if (isset($_GET["download_item"]) && !empty($_GET['download_item']) && is_user_logged_in()) {
			$this->umetric_send_download_file($_GET['download_item']);
		}
	}
	public	function umetric_send_download_file($remoteURL)
	{

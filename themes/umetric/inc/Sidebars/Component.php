...
/**
 * Umetric\Utility\Sidebars\Component class
 *
 * @package umetric
 */

namespace Umetric\Utility\Sidebars;
 ...
 * * `umetric()->is_primary_sidebar_active()`
 * * `umetric()->display_primary_sidebar()`
 *
...
class Component implements Component_Interface, Templating_Component_Interface
{
	...
	public function action_register_sidebars()
	{
		register_sidebar(
			array(
				'name' => esc_html__('Blog Sidebar', 'umetric'),
				'id' => static::PRIMARY_SIDEBAR_SLUG,
				'description' => esc_html__('Add widgets here.', 'umetric'),
		...
		if( class_exists('ReduxFramework') ) {
			register_sidebar( array(
				'name'          => esc_html__('Footer Top Area','umetric'),
				'class'         => 'nav-list',
				'id'            => 'footer_top_area',
			...
			register_sidebar( array(
				'name'          => esc_html__('Side Area','umetric'),
				'class'         => 'nav-list',
				'id'            => 'iq_side_area',
				'before_widget' => '<div class="widget">',
				'after_widget'  => '</div>',
				'before_title'  => '<h4 class="iq-side-area-title">',
				'after_title'   => '</h4>',
			) );
		}
	...
	{
		$this->get_option =  get_option('umetric_options');

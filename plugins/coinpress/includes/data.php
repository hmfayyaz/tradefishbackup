    ...
    class CoinpressData {
        ...
        public function __construct() {
            ...
            $this->config = array(
                ...
                'changelly' => '',
                'css' => '',
                'title' => '[coinmc type="name"] price, charts, marketcap and other stats',
                'description' => '[coinmc type="name"] is a cryptocurrency with a price of [coinmc type="price"] and marketcap of [coinmc type="marketcap"]. [coinmc type="name"]\'s market price has [coinmc type="changetext"] [coinmc type="change"] in the last 24 hours. It ranks [coinmc type="rank"] amongst all cryptocurrencies with daily volume of [coinmc type="volume"].',
                'meta_description' => '[coinmc type="name"] is a cryptocurrency with a price of [coinmc type="price"] and marketcap of [coinmc type="marketcap"]. [coinmc type="name"]\'s market price has [coinmc type="changetext"] [coinmc type="change"] in the last 24 hours. It ranks [coinmc type="rank"] amongst all cryptocurrencies with daily volume of [coinmc type="volume"].',
                'theme_color' => '#7093fe',
                'sitemap_update' => 0,
            ...
            $this->options = array(
                ...
                'coins' => array(),
                'numcoins' => 0,
                'global_position' => 'header',
                'global_color' => 'midnight',
                'table_type' => 'advanced',
                'table_restype' => 'scroll',
                'table_style' => 'light',
                'table_length' => 25,
                'table_columns' => array('rank', 'name', 'price_usd', 'market_cap_usd', 'volume_usd_24h', 'available_supply', 'percent_change_24h', 'weekly', 'actions'),
                'table_order' => 'rank',
                'table_order_dir' => 'asc',
                'settings' => array('realtime', 'linkto'),
                'currency' => 'USD',
                'chart_color' => '#2861F5',
                'text_color' => '#000',
                'background_color' => '',
            ...
            $this->providers = array(
                'coingecko' => COINMC_URL . 'assets/admin/img/coingecko.png',
                'coinmarketcap' => COINMC_URL . 'assets/admin/img/coinmarketcap.svg'
            );

            $this->dynamic_columns = array('keywords');

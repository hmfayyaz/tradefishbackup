(function ($) {
    ...
    var VisualFluidAnimation = {
        initFluid: function () {
            ...
            elementorFrontend.hooks.addAction('frontend/element_ready/container', VisualFluidAnimation.initFluidWidget);
        },
        initFluidWidget: function ($scope) {
            ...
            if (window.isEditMode || window.elementorFrontend.isEditMode()) {
                ...
                $.each(editorElements.models, function (i, el) {
                    ...
                    if(Object.keys(fluidAnimationArgs).length !== 0){
                        
                        if(fluidAnimationArgs.__globals__ && fluidAnimationArgs.__globals__.marvy_fluid_animation_background_color && fluidAnimationArgs.__globals__.marvy_fluid_animation_background_color !== ""){
                            var bgColor_id = fluidAnimationArgs.__globals__.marvy_fluid_animation_background_color.split('=')[1];
                        ...
                        if(fluidAnimationArgs.__globals__ && fluidAnimationArgs.__globals__.marvy_fluid_animation_single_color && fluidAnimationArgs.__globals__.marvy_fluid_animation_single_color !== ""){
                            var single_color_id = fluidAnimationArgs.__globals__.marvy_fluid_animation_single_color.split('=')[1];
                            var single_color_arr = global_color.find(element => element._id  === single_color_id);
                            settings.single_color = single_color_arr.color; 
                        }
                        else{
                            settings.single_color = fluidAnimationArgs.marvy_fluid_animation_single_color; 
                        }                      
    ...
    function fluidAnimation(target, settings, sectionId) {
        ...
        if (checkElement.length >= 0) {
            ...
            var fluidZindex = document.querySelector('.marvy-custom-fluid-animation-section-' + sectionId + ' .elementor-container , .marvy-custom-fluid-animation-section-' + sectionId + '>*');

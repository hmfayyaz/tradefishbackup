(function( $ ) {
    ...
    var VisualCellsAnimation = {
        initCells: function () {
            ...
            elementorFrontend.hooks.addAction('frontend/element_ready/container', VisualCellsAnimation.initCellsWidget);
        },
        initCellsWidget: function ($scope) {
            ...
            if (window.isEditMode || window.elementorFrontend.isEditMode()) {
                ...
                $.each(editorElements.models, function (i, el) {
                    ...
                    if(Object.keys(cellsAnimationArgs).length !== 0){
                        
                        if(cellsAnimationArgs.__globals__ && cellsAnimationArgs.__globals__.marvy_cells_animation_color && cellsAnimationArgs.__globals__.marvy_cells_animation_color !== ""){
                            var colorOne_id = cellsAnimationArgs.__globals__.marvy_cells_animation_color.split('=')[1];
                        ...
                        if(cellsAnimationArgs.__globals__ && cellsAnimationArgs.__globals__.marvy_cells_animation_color_two && cellsAnimationArgs.__globals__.marvy_cells_animation_color_two !== ""){
                            var colorTwo_id = cellsAnimationArgs.__globals__.marvy_cells_animation_color_two.split('=')[1];
    ...
    function cellsAnimation(target,settings,sectionId) {
        ...
        if (checkElement.length >= 0) {
            ...
            var cellsZindex = document.querySelector('.marvy-custom-cells-animation-section-'+sectionId+' .elementor-container , .marvy-custom-cells-animation-section-'+sectionId+'>*');

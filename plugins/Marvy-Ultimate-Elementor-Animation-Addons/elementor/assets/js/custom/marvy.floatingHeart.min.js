(function( $ ) {
    ...
    var VisualFloatingHeartAnimation = {
        initFloatingHeart: function () {
            ...
            elementorFrontend.hooks.addAction('frontend/element_ready/container', VisualFloatingHeartAnimation.initFloatingHeartWidget);
        },
            ...
            if (window.isEditMode || window.elementorFrontend.isEditMode()) {
                ...
                $.each(editorElements.models, function (i, el) {
                    ...
                    if(floatingHeartAnimationArgs.marvy_enable_floating_heart_animation) {                        
                        ...
                        if(Object.keys(floatingHeartAnimationArgs).length !== 0){
                        
                            if(floatingHeartAnimationArgs.__globals__ && floatingHeartAnimationArgs.__globals__.marvy_floating_heart_animation_color_1 && floatingHeartAnimationArgs.__globals__.marvy_floating_heart_animation_color_1 !== ""){
                                var color1_id = floatingHeartAnimationArgs.__globals__.marvy_floating_heart_animation_color_1.split('=')[1];
                                var color1_arr = global_color.find(element => element._id  === color1_id);
                                settings.color1 = color1_arr.color; 
                            }
                            else{
                                settings.color1 = floatingHeartAnimationArgs.marvy_floating_heart_animation_color_1;
                            }
                            if(floatingHeartAnimationArgs.__globals__ && floatingHeartAnimationArgs.__globals__.marvy_floating_heart_animation_color_2 && floatingHeartAnimationArgs.__globals__.marvy_floating_heart_animation_color_2 !== ""){
                                var color2_id = floatingHeartAnimationArgs.__globals__.marvy_floating_heart_animation_color_2.split('=')[1];
                                var color2_arr = global_color.find(element => element._id  === color2_id);
                                settings.color2 = color2_arr.color; 
                            }
                            else{
                                settings.color2 = floatingHeartAnimationArgs.marvy_floating_heart_animation_color_2;
                            }
                            if(floatingHeartAnimationArgs.__globals__ && floatingHeartAnimationArgs.__globals__.marvy_floating_heart_animation_color_3 && floatingHeartAnimationArgs.__globals__.marvy_floating_heart_animation_color_3 !== ""){
                                var color3_id = floatingHeartAnimationArgs.__globals__.marvy_floating_heart_animation_color_3.split('=')[1];
                                var color3_arr = global_color.find(element => element._id  === color3_id);
                                settings.color3 = color3_arr.color; 
                            }
                            else{
                                settings.color3 = floatingHeartAnimationArgs.marvy_floating_heart_animation_color_3;
                            }
                            if(floatingHeartAnimationArgs.__globals__ && floatingHeartAnimationArgs.__globals__.marvy_floating_heart_animation_color_4 && floatingHeartAnimationArgs.__globals__.marvy_floating_heart_animation_color_4 !== ""){
                                var color4_id = floatingHeartAnimationArgs.__globals__.marvy_floating_heart_animation_color_4.split('=')[1];
                                var color4_arr = global_color.find(element => element._id  === color4_id);
                                settings.color4 = color4_arr.color; 
                            }
                            else{
                                settings.color4 = floatingHeartAnimationArgs.marvy_floating_heart_animation_color_4;
                            }                      
    ...
    function floatingHeartAnimation(target,settings,sectionId) {
        ...
        if (checkElement.length >= 0 && settings) {
            ...
            var flotingHeartZindex = document.querySelector('.marvy-custom-floating-heart-animation-section-'+sectionId+' .elementor-container , .marvy-custom-floating-heart-animation-section-'+sectionId+'>*');

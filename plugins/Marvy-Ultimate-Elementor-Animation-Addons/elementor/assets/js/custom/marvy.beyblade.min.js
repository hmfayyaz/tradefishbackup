(function ($) {
    ...
    var VisualBeyBladeAnimation = {
        initFog: function () {
            ...
            elementorFrontend.hooks.addAction('frontend/element_ready/container', VisualBeyBladeAnimation.initBeyBladeWidget);
        },
        initBeyBladeWidget: function ($scope) {
            ...
            if (window.isEditMode || window.elementorFrontend.isEditMode()) {
                ...
                $.each(editorElements.models, function (i, el) {
                    ...
                    if(Object.keys(beyBladeAnimationArgs).length !== 0){                       
                        if(typeof beyBladeAnimationArgs.marvy_beyblade_animation_color_multiples == "object"){
                            settings.color_multiples = beyBladeAnimationArgs.marvy_beyblade_animation_color_multiples.models?.map((val,index)=>{
                        ...
                        if(beyBladeAnimationArgs.__globals__ && beyBladeAnimationArgs.__globals__.marvy_beyblade_animation_color_single && beyBladeAnimationArgs.__globals__.marvy_beyblade_animation_color_single !== ""){
                            var color_single_id = beyBladeAnimationArgs.__globals__.marvy_beyblade_animation_color_single.split('=')[1];
    ...
    function beyBladeAnimation(target, mainSettings, sectionId) {
        ...
        if (checkElement.length >= 0) {
            ...
            var beybladeZindex = document.querySelector('.marvy-custom-beyblade-animation-section-' + sectionId + ' .elementor-container , .marvy-custom-beyblade-animation-section-' + sectionId + '>*');
            beybladeZindex.style.zIndex = '99';

            // Set min height
            var beybladeMinHeight = document.querySelector(".elementor-element-" + sectionId);
            beybladeMinHeight.closest('.elementor-top-section,.e-con-boxed,.e-con-full').style.minHeight = "100px";
            // Canvas Setup End

(function( $ ) {
    ...
    var VisualDigitalStreamAnimation = {
        initDigitalStream: function () {
            ...
            elementorFrontend.hooks.addAction('frontend/element_ready/container', VisualDigitalStreamAnimation.initDigitalStreamWidget);
        },
        initDigitalStreamWidget: function ($scope) {
            ...
            if (window.isEditMode || window.elementorFrontend.isEditMode()) {
                ...
                $.each(editorElements.models, function (i, el) {
                    ...
                    if(Object.keys(digitalStreamAnimationArgs).length !== 0){
                        
                      if(digitalStreamAnimationArgs.__globals__ && digitalStreamAnimationArgs.__globals__.marvy_digitalStream_animation_color && digitalStreamAnimationArgs.__globals__.marvy_digitalStream_animation_color !== ""){
                          var color_id = digitalStreamAnimationArgs.__globals__.marvy_digitalStream_animation_color.split('=')[1];
                      ...
                      if(digitalStreamAnimationArgs.__globals__ && digitalStreamAnimationArgs.__globals__.marvy_digitalStream_animation_background_color && digitalStreamAnimationArgs.__globals__.marvy_digitalStream_animation_background_color !== ""){
                        var bgColor_id = digitalStreamAnimationArgs.__globals__.marvy_digitalStream_animation_background_color.split('=')[1];

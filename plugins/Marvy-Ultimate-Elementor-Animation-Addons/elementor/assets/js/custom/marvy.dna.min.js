(function ($) {
    ...
    var VisualDNAAnimation = {
        initDNA: function () {
            ...
            elementorFrontend.hooks.addAction('frontend/element_ready/container', VisualDNAAnimation.initDNAWidget);
        },
            ...
            if (window.isEditMode || window.elementorFrontend.isEditMode()) {
                ...
                $.each(editorElements.models, function (i, el) {
                    ...
                    if (dnaAnimationArgs.marvy_enable_dna_animation) {
                        ...
                        if(Object.keys(dnaAnimationArgs).length !== 0){
                        
                            if(dnaAnimationArgs.__globals__ && dnaAnimationArgs.__globals__.marvy_dna_animation_background_color && dnaAnimationArgs.__globals__.marvy_dna_animation_background_color !== ""){
                                var background_color_id = dnaAnimationArgs.__globals__.marvy_dna_animation_background_color.split('=')[1];
                                var background_color_arr = global_color.find(element => element._id  === background_color_id);
                                settings.background_color = background_color_arr.color; 
                            }
                            else{
                                settings.background_color = dnaAnimationArgs.marvy_dna_animation_background_color
                            }
                            if(dnaAnimationArgs.__globals__ && dnaAnimationArgs.__globals__.marvy_dna_animation_border_color_1 && dnaAnimationArgs.__globals__.marvy_dna_animation_border_color_1 !== ""){
                                var border_color_1_id = dnaAnimationArgs.__globals__.marvy_dna_animation_border_color_1.split('=')[1];
                                var border_color_1_arr = global_color.find(element => element._id  === border_color_1_id);
                                settings.border_color_1 = border_color_1_arr.color; 
                            }
                            else{
                                settings.border_color_1 = dnaAnimationArgs.marvy_dna_animation_border_color_1;
                            }
                            if(dnaAnimationArgs.__globals__ && dnaAnimationArgs.__globals__.marvy_dna_animation_border_color_2 && dnaAnimationArgs.__globals__.marvy_dna_animation_border_color_2 !== ""){
                                var border_color_2_id = dnaAnimationArgs.__globals__.marvy_dna_animation_border_color_2.split('=')[1];
                                var border_color_2_arr = global_color.find(element => element._id  === border_color_2_id);
                                settings.border_color_2 = border_color_2_arr.color; 
                            }
                            else{
                                settings.border_color_2 = dnaAnimationArgs.marvy_dna_animation_border_color_2;
                            }   
                            if(dnaAnimationArgs.__globals__ && dnaAnimationArgs.__globals__.marvy_dna_animation_fill_color_1 && dnaAnimationArgs.__globals__.marvy_dna_animation_fill_color_1 !== ""){
                                var fill_color_1_id = dnaAnimationArgs.__globals__.marvy_dna_animation_fill_color_1.split('=')[1];
                                var fill_color_1_arr = global_color.find(element => element._id  === fill_color_1_id);
                                settings.fill_color_1 = fill_color_1_arr.color; 
                            }
                            else{
                                settings.fill_color_1 = dnaAnimationArgs.marvy_dna_animation_fill_color_1;
                            }
                            if(dnaAnimationArgs.__globals__ && dnaAnimationArgs.__globals__.marvy_dna_animation_fill_color_2 && dnaAnimationArgs.__globals__.marvy_dna_animation_fill_color_2 !== ""){
                                var fill_color_2_id = dnaAnimationArgs.__globals__.marvy_dna_animation_fill_color_2.split('=')[1];
                                var fill_color_2_arr = global_color.find(element => element._id  === fill_color_2_id);
                                settings.fill_color_2 = fill_color_2_arr.color; 
                            }
                            else{
                                settings.fill_color_2 = dnaAnimationArgs.marvy_dna_animation_fill_color_2;
                            }
                            if(dnaAnimationArgs.__globals__ && dnaAnimationArgs.__globals__.marvy_dna_animation_particles_color && dnaAnimationArgs.__globals__.marvy_dna_animation_particles_color !== ""){
                                var particles_color_id = dnaAnimationArgs.__globals__.marvy_dna_animation_particles_color.split('=')[1];
                                var particles_color_arr = global_color.find(element => element._id  === particles_color_id);
                                settings.particles_color = particles_color_arr.color; 
                            }
                            else{
                                settings.particles_color = dnaAnimationArgs.marvy_dna_animation_particles_color;
                            } 
    ...
    function dnaAnimation(target, settings, sectionId) {
        ...
        if (checkElement.length >= 0 && settings) {
            ...
            var dnaZindex = document.querySelector('.marvy-custom-dna-animation-section-' + sectionId + ' .elementor-container , .marvy-custom-dna-animation-section-' + sectionId + '>*');

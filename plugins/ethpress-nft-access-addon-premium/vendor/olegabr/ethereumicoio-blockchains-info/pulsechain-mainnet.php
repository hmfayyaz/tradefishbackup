...
//         "pulsechain" => __('PulseChain Mainnet', 'ethereum-wallet'),
//     ));
// }, 200, 1);

add_filter('ethereumico.io/supported-blockchains-info', function ($blockchains) {
    $info = apply_filters('ethereumico.io/blockchain-info', $blockchains && isset($blockchains['a369']) ? $blockchains['a369'] : null, 369);
    return array_merge($blockchains, array(
        "pulsechain" => $info,
        "a369" => $info,
    ));
...
add_filter('ethereumico.io/blockchain-info', function ($info, $chainId) {
    ...
    return array_merge($info ? $info : array(), array(
        ...
        'blockchain_display_name' => 'PulseChain Mainnet',
        ...
        'txhash_path_template' => 'https://scan.pulsechain.com/tx/%s',
        'address_path_template' => 'https://scan.pulsechain.com/address/%s',
        ...
        'base_explorer_display_url' => 'scan.pulsechain.com',

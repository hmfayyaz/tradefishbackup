...
add_filter('ethereumico.io/supported-blockchains', function ($blockchains) {
    return array_merge($blockchains, array(
        "avalanche-fuji" => __('Avalanche (C-Chain) Fuji Testnet', 'ethereum-wallet'),
    ));
}, 29, 1);

add_filter('ethereumico.io/supported-blockchains-info', function ($blockchains) {
    $info = apply_filters('ethereumico.io/blockchain-info', $blockchains && isset($blockchains['a43113']) ? $blockchains['a43113'] : null, 43113);
    return array_merge($blockchains, array(
        "avalanche-fuji" => $info,
        "a43113" => $info,
    ));
...
add_filter('ethereumico.io/blockchain-info/blockchain-id', function ($blockchainId, $blockchainName) {
    if (!in_array($blockchainName, ['avalanche-fuji'])) {
        return $blockchainId;
    }
    return 43113;
...
add_filter('ethereumico.io/blockchain-info', function ($info, $chainId) {
    ...
    $base_url = 'https://api-testnet.snowtrace.io/api?';
    ...
    return array_merge($info ? $info : array(), array(
        ...
        'blockchain_display_name' => 'Avalanche (C-Chain) Fuji',
        ...
        'txhash_path_template' => 'https://testnet.snowtrace.io/tx/%s',
        'address_path_template' => 'https://testnet.snowtrace.io/address/%s',
        ...
        'base_explorer_display_url' => 'testnet.snowtrace.io',

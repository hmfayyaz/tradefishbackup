...
//         "pulsechain" => __('PulseChain Testnet v4', 'ethereum-wallet'),
//     ));
// }, 200, 1);

add_filter('ethereumico.io/supported-blockchains-info', function ($blockchains) {
    $info = apply_filters('ethereumico.io/blockchain-info', $blockchains && isset($blockchains['a943']) ? $blockchains['a943'] : null, 943);
    return array_merge($blockchains, array(
        "pulsechain" => $info,
        "a943" => $info,
    ));
...
add_filter('ethereumico.io/blockchain-info/blockchain-id', function ($blockchainId, $blockchainName) {
    if (!in_array($blockchainName, ['pulsechain'])) {
        return $blockchainId;
    }
    return 943;
...
add_filter('ethereumico.io/blockchain-info', function ($info, $chainId) {
    ...
    $base_url = 'https://scan.v4.testnet.pulsechain.com/api?';
    ...
    return array_merge($info ? $info : array(), array(
        ...
        'blockchain_display_name' => 'PulseChain Testnet v4',
        'interblock_period_seconds' => 10,
        'currency_ticker' => 'tPLS',
        'currency_name' => 'tPLS',
        ...
        'txhash_path_template' => 'https://scan.v4.testnet.pulsechain.com/tx/%s',
        'address_path_template' => 'https://scan.v4.testnet.pulsechain.com/address/%s',
        ...
        'base_explorer_display_url' => 'scan.v4.testnet.pulsechain.com',

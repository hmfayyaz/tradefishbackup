...
?>
	...
	public static function login_button()
	{
		...
		if (\losnappas\Ethpress\ethpress_fs()->can_use_premium_code__premium_only()) {
			...
			$label  = isset($options['login_button_label']) && !empty($options['login_button_label']) ? $options['login_button_label'] : $label;
		}
	...
	public static function link_button()
	{
		...
		if (!$is_user_logged_in) {
			...
			if (\losnappas\Ethpress\ethpress_fs()->can_use_premium_code__premium_only()) {
				...
				$options = \get_site_option('ethpress', $defopts);
				$label  = isset($options['link_button_label']) && !empty($options['link_button_label']) ? $options['link_button_label'] : $label;
			}
		?>
	...
	public static function register_button()
	{
		...
		if (\losnappas\Ethpress\ethpress_fs()->can_use_premium_code__premium_only()) {
			...
			$options = \get_site_option('ethpress', $defopts);
			$label  = isset($options['register_button_label']) && !empty($options['register_button_label']) ? $options['register_button_label'] : $label;
		}
	?>
		<button class="ethpress-metamask-login-button ethpress-button ethpress-button-secondary ethpress-button-large woocommerce-Button button" type="button" name="metamask">
			<?php echo $label ?>

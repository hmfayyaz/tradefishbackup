...
class Timeline_chart extends Widget_Base
{
    ...
    protected function render()
    {
        ...
        if (isRestrictedAccess('timeline', $mainId, $settings, false) === false) {
            ?>
            ...
            <script>
                ...
                var timelineOptions = {
                    ...
                    stroke: {
                        ...
                        colors: ['<?php echo isset($settings['iq_'.$type.'_chart_stroke_color']) ? $settings['iq_'.$type.'_chart_stroke_color'] : 'black';?>']
                    },
                    tooltip: {

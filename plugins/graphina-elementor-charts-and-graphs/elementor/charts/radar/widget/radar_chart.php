...
class Radar_chart extends Widget_Base
{
    ...
    protected function render()
    {
        ...
        if (isRestrictedAccess('radar', $mainId, $settings, false) === false) {
            ?>
            <script>
                ...
                var radarOptions = {
                    ...
                    if("<?php echo $settings['iq_' . $type . '_chart_yaxis_datalabel_format'] == 'yes'?>"){
                        radarOptions.yaxis.labels.formatter = function (val,opt){
                            ...
                            return '<?php  echo  !empty($settings[ 'iq_' . $type . '_chart_yaxis_format_prefix']) ? esc_html($settings[ 'iq_' . $type . '_chart_yaxis_format_prefix']): '' ; ?>' + val + '<?php echo !empty($settings[ 'iq_' . $type . '_chart_yaxis_format_postfix']) ? esc_html($settings[ 'iq_' . $type . '_chart_yaxis_format_postfix']): ''; ?>';
                        }
                    }

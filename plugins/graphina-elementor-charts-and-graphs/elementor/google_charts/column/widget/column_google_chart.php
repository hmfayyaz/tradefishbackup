...
//        require GRAPHINA_ROOT . '/elementor/google_charts/column/render/column_google_chart.php';
        ...
        if($settings['iq_' . $type . '_chart_data_option'] === 'manual'){
            ...
            foreach ($settings['iq_' . $type . '_category_list'] as $key => $value ){
                $columnData[$key][] = $xaxisPrefix .$value['iq_' . $type . '_chart_category'] . $xaxisPostfix;
            }
        }
                ...
                function drawChart() {
                    ...
                    if (typeof graphinaGoogleChartInit !== "undefined") {
                        graphinaGoogleChartInit(
                            document.getElementById('column_google_chart<?php esc_attr_e($mainId); ?>'),
                            {
                                ele:document.getElementById('column_google_chart<?php esc_attr_e($mainId); ?>'),
                                options: options,
                                series: data,
                                animation: true,

...
//                        'iq_' . $type . '_chart_data_option' => 'manual'
    ...
    protected function render(){
        ...
        for ($i = 0; $i < $settings['iq_' . $type . '_chart_data_series_count']; $i++) {
            $colors[] =(string)$settings['iq_' . $type . '_chart_element_color_' . $i];
            ...
            <script type="text/javascript">
                (function ($) {
                    ...
                    function drawChart() {
                        ...
                        data.addRows(<?php echo $donutData; ?>);
                        var legendPosition = '<?php echo strval($settings['iq_' . $type . '_google_chart_legend_show'] === 'yes' ?   $settings['iq_' . $type . '_google_piechart_legend_position'] : 'none'); ?>';
                        ...
                        var optionsData = {
                            ...
                            chartArea: legendPosition === 'top' ? {top: '15%', width: '100%', height: '80%'} : {width: '100%', height: '80%'},
                        ...
                        if (typeof graphinaGoogleChartInit !== "undefined") {
                            graphinaGoogleChartInit(
                                document.getElementById('donut_google_chart<?php esc_attr_e($mainId); ?>'),
                                {
                                    ele: document.getElementById('donut_google_chart<?php esc_attr_e($mainId); ?>'),
                                    options: optionsData,
                                    series: data,
                                    animation: true,
                                    renderType: 'PieChart',

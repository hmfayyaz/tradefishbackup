...
function graphina_chart_data_enter_options($type = '', $chartType = '', $first = false)
{
    ...
    switch ($type) {
        ...
        case 'dynamic':
            ...
            $sql_builder_for = ['line', 'column', 'area', 'pie', 'donut', 'radial', 'radar', 'polar','data_table_lite','distributed_column','scatter','mixed','brush', 'pie_google','donut_google','line_google','area_google','column_google','bar_google','gauge_google','geo_google','org_google'];
...
if(!in_array($type, ['geo_google'])){
    ...
    if (!in_array($type, ['nested_column','brush','gantt_google'])) {
        $this_ele->add_control(
    ...
    if(!in_array($type,['mixed','brush','nested_column','area_google', 'pie_google', 'bar_google','column_google','donut_google','gauge_google','geo_google','org_google'])){
...
function graphina_chart_style($this_ele, $type = 'chart_id')
{
    ...
    if(!in_array($type,['line_google','area_google','bar_google','column_google','pie_google','donut_google','org_google','geo_google','gantt_google','gauge_google'])){
        $this_ele->add_control(
